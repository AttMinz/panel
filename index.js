...
const apikey = 'ptla_N1YDFd2uh5sQ70IYsBgkhFzX94M0JWoo4Tgg4lagScK';
const capikey = 'ptlc_i2eY5EP2yTOEgf6OhRNCTXmovyN0IE5LiBNFcAQQrGM';
const domain = 'https://public.accept.new.by.lightsecretaja.web.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com';
const telegramBotToken = '8193565955:AAEiKq-KsVs1XRYFVaQeQPppZDydQL8SJ4U';
const adminTelegramId = '7780251032';
let servers = [];
let users = [];
let admins = [];
...
app.get('/api', (req, res) => {
  res.json({
    message: 'ZEROXONE Pterodactyl Panel Management API',
    endpoints: {
